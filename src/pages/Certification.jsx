...
import { ArrowRight, Check, Edit3, Scissors, Sparkles, BookOpen, Award, Users } from "lucide-react";
...
export default function Certification() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer:
        "The core certification is self-paced. Optional private sessions or group upgrades are available.",
    },
  ];
        ...
        <div className="max-w-5xl mx-auto px-6">
          ...
          >
            ...
            <p className="text-[#2B2725]/80 text-lg leading-relaxed mb-10 max-w-3xl mx-auto">
              ...
              certification is designed to help you understand how your mind actually works, release
              the patterns that no longer fit, and become the person you've been trying to step into.
            </p>

            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link
                to="/app/signup?intent=certification"
                ...
                <div className="relative z-10">
                  ...
                  <div className="grid lg:grid-cols-2 gap-10">
                    ...
                    <div className="flex flex-col justify-between">
                      ...
                      >
                        {index === 0 ? "Start Your Certification" : "Enroll Now"}
                        <ArrowRight
                          size={16}
                          className="group-hover:translate-x-1 transition-transform"
                        />
        ...
        <div className="max-w-4xl mx-auto px-6">
          ...
          >
            ...
            <p className="text-[#F9F5EF]/80 text-lg mb-10">
              By the end of this certification, you will:
            </p>
        ...
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          >
            <h2 className="font-serif text-3xl md:text-4xl lg:text-5xl text-[#F9F5EF] leading-tight mb-6">
              Begin Your Mind Styling Journey
            </h2>
