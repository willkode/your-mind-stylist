...
export default function MasterclassConfirmation({ userName, masterclassUrl }) {
  return (
    <div style={{ fontFamily: 'Georgia, serif', maxWidth: '600px', margin: '0 auto', backgroundColor: '#F9F5EF' }}>
      ...
      <div style={{ padding: '50px 30px', backgroundColor: '#FFFFFF' }}>
        ...
        <div style={{ borderLeft: '3px solid #D8B46B', paddingLeft: '20px', marginTop: '40px' }}>
          <p style={{ fontSize: '16px', color: '#2B2725', lineHeight: '1.6', fontStyle: 'italic', margin: '0' }}>
